...
//Child Class Employee inherits virtual Parent Class Person
...
//Officer Parameterized constructors : Employee Class Constructor
...
Officer(string n,string d, int a,string g,string b,string h,string w,string st,string m,string na,string nid,string ad,string ph,string eid,
                string e_id,string de,string ds,string wt,string s,string dj,string cn):Employee(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,
                                                                                                 eid,e_id,de,ds,wt,s,dj),Person(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid)
{
        company_name=cn;
}
...
{
//data members for faculty class
...
//Faculty Parameterized constructors : Employee constructor
...
{
//data members for graduate class
//Access modifiers
...
Graduate(string n,string d, int a,string g,string b,string h,string w,string st,string m,string na,string nid,
        ...
        string cg2,string dur,string maj,string the,string jo):Student(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid,
                                                                uname,dept,stid,cg,sem,cre,ye,sec,ol,sn,al,cn),Person(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid)
        {
...
//TA class virtually inherited faculty class and student class

class TA :  virtual public Faculty , virtual public Student
{

//data members for TA class
...
//TA parametrized Constructor

        TA(string n,string d, int a,string g,string b,string h,string w,string st,string m,string na,string nid,string ad,
           string ph,string eid,string e_id,string de,string ds,string wt,string s,string dj,string un,string deg,
           string uname,string dept,string stid,string cg,string sem,string cre,string ye,string sec,string ol,string sn,string al,string cn,string bo,string ro):
           Faculty(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid,e_id,de,ds,wt,s,dj,un,deg),Student(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid,uname,dept,stid,cg,sem,cre,ye,sec,ol,sn,al,cn),
           Person(n,d,a,g,b,h,w,st,m,na,nid,ad,ph,eid)
{
        boss = bo;
        role = ro;
}
...
//Getter Method
        ...
        string getBoss()        {return boss;}
        string getRole()        {return role;}

//Show Function TA Class
...
void    showTA(){
        ...
        cout<<"Credit Completed                 : "<<credit<<endl;
        cout<<"Designation                      : "<<designation<<endl;
        cout<<"TA of                            : "<<boss<<endl;
        cout<<"Role                             : "<<role<<endl;
        cout<<"TA ID                            : "<<employee_id<<endl;
        cout<<"Work Hour                        : "<<work_time<<endl;
        cout<<"Salary                           : "<<salary<<endl;
        cout<<"Joining Date                     : "<<date_join<<endl;
        cout<<endl;
...
TA t1("Nanjiba Khan","22-03-1997",25,"Female","A(-)","string h","string w","string st","Single","string na","199-722-0312","182 East Kafrul Dhaka Cantonment Dhaka -1206",
       "01715658970","naji_ba@gmail.com","TA-1921","CSE","Teacher Assistant","12PM - 4PM","5000 BDT","22-04-2021","American International University - Bangladesh",
       "string deg","string uname","string dept","19-46481-1","3.75","10th","132","string ye","string sec","string ol","string sn","string al","string cn","Abdul Aziz",
       "Supervise Students");
